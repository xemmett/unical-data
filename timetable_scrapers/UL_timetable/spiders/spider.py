...
class Scraper(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        module_timetable_page_link = response.xpath("/html/body/form/div[3]/div/div/div[4]/a/@href").get() # /html/body/form/div[5]/div/div/div[4]/a
    ...
    def module_page(self, response):
        ...
        for module in self.modules:
            yield FormRequest.from_response(response, formdata={"__EVENTVALIDATION": token, "__EVENTTARGET": 'ctl00$HeaderContent$DropDownList1', "ctl00$HeaderContent$DropDownList1": module}, headers={'Origin': 'https://timetable.ul.ie', 'Referer': 'https://timetable.ul.ie/UA/ModuleTimetable.aspx'}, callback=self.GetTimetable)
