...
num_of_courses = 0
num_of_years = 0
for i in range(1, 300): # <- check this!!
    num_of_courses+=1
    ...
    try:
        ...
        for year in range(2, 8):
            ...
            try:
                ...
                with open(r'C:\Users\Emmett\magi-spiders\timetable_scrapers\course_webpages_2021\{}.html'.format(course_name+'_'+course_year), 'w+') as of:
